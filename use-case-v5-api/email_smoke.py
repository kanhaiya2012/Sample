...
body = Send()
body.reply_to = 'qwer@ppoi.com'
body.mfrom = From()
body.mfrom.email = 'testemail@pepitest.xyz'
body.mfrom.name = 'fromdomain'
body.subject = 'API V5 test'
body.template_id = 1
body.content = []

body.content.append(Content())
body.content[0].mtype = TypeEnum.HTML
body.content[0].value = 'Using this API, you can pass the components of the messages such as To/Recipient, From, Subject, HTML/Content, attachments, etc. Pepipost will build a MIME representation of the message and send it.'
...
body.personalizations[0].bcc[0].email = 'archana.jadhav@netcore.co.in'

body.personalizations[0].token_to = '{"token_to": "token2value"}'
...
body.personalizations[1].token_to = '{"sdasdasd": "token2value"}'
...
body.tags = ['name,laborum deserunt proiden']
body.lint_payload = True
body.schedule = 1588069407
