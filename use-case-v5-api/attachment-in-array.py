...
body.mfrom = From()
body.mfrom.email = 'attcahmentvalidations@pepitest.xyz'
body.mfrom.name = 'attcahmentvalidations'
body.subject = 'attcahmentvalidations'
body.content = []

body.content.append(Content())
body.content[0].mtype = TypeEnum.HTML
body.content[0].value = 'text test test plain text'
...
body.attachments.append(Attachments())
body.attachments[1].content = 'dGVzdCB0ZXN0DQp0ZXN0IHRlc3Q='
body.attachments[1].name = 'tesxt2file.txt'

body.attachments.append(Attachments())
body.attachments[2].content = 'dGVzdCB0ZXN0DQp0ZXN0IHRlc3Q='
body.attachments[2].name = 'tesxt3file.txt'

body.attachments.append(Attachments())
body.attachments[3].content = 'dGVzdCB0ZXN0DQp0ZXN0IHRlc3Q='
body.attachments[3].name = 'tesxt4file.txt'

body.attachments.append(Attachments())
body.attachments[4].content = 'dGVzdCB0ZXN0DQp0ZXN0IHRlc3Q='
body.attachments[4].name = 'tesxt5file.txt'
